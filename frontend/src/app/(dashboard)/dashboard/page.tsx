  ...
  return (
    <div className="page-content">
      ...
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:16 }}>
        ...
        <div style={{ display:"flex", gap:3, background:"rgba(250,247,242,0.9)", border:"1px solid rgba(180,155,110,0.25)", borderRadius:10, padding:3 }}>
          {PERIODS.map((p) => (
            <button key={p.key} onClick={() => setPeriod(p.key)} style={{
              padding:"5px 14px", fontSize:12, fontWeight:700, borderRadius:8, cursor:"pointer",
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))", gap:14, marginBottom:22 }}>
        <MetricCard label="Total Revenue"   value={summary?.totalRevenue    ||0} icon={IndianRupee}   accent="olive"  delay={0}   isLoading={summaryLoading} change="+12.4%" />
